...
export default class SearchAllegations extends LightningElement {
    @api recordId;
    @track isOpenAllegationModal = true;
    @track allegationSearchValue = '';
    ...
    handleCloseAllegationModal(){
        ...
        const closeAllegationModalEvent = new CustomEvent("closeallegationmodal", {
            detail: this.isOpenAllegationModal
        });
    ...
    selectRow(event){
        this.allegationChosen = this.allegationsToDisplay[event.currentTarget.dataset.index].Id;
        ...
        this.handleCloseAllegationModal();
    }
}