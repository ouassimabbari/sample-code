...
export default class SearchCallCenterSolutions extends LightningElement {
    ...
    @track isOpenCallCenterSolutionModal = true;
    @track callCenterSolutionSearchValue = '';
    ...
    handleCloseCallCenterSolutionModal(){
        ...
        const closeCallCenterSolutionModalEvent = new CustomEvent("closecallcentersolutionmodal", {
            detail: this.isOpenCallCenterSolutionModal
        });
    ...
    selectRow(event){
        this.callCenterSolutionChosen = this.callCenterSolutionsToDisplay[event.currentTarget.dataset.index].Id;
        const selectCallCenterSolutionEvent = new CustomEvent("selectcallcentersolution", {
            detail: this.callCenterSolutionChosen
        });
        this.dispatchEvent(selectCallCenterSolutionEvent);
        this.handleCloseCallCenterSolutionModal();
    }
